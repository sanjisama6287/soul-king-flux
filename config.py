...
CHANNEL_ONE = int(os.environ.get("CHANNEL_ONE", "-1002339515485")) 
CHANNEL_TWO = int(os.environ.get("CHANNEL_TWO", "-1002280632222"))
...
try:
    ADMINS=[6727550037]
    for x in (os.environ.get("ADMINS", "6496242324 1683225887 7162615398 6685624393 7827448605").split()):
        ADMINS.append(int(x))
except ValueError:
